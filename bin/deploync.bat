...
@echo  "----------------------------------------------------------------------"
@echo on
\bin\java -Xint -DJA_HOME=%JA_HOME% -DORACLE_HOME=C:\Users\uwalia\Desktop\TRASH\VBCS\V1046557-01\Oracle_Home -DJA_LIBS_HOME=C:\Users\uwalia\Desktop\TRASH\VBCS\V1046557-01\Oracle_Home -DJAVA_HOME= -DJAVA_HOME_CLASSPATH=%JAVA_HOME_CLASSPATH% -classpath %JACLASSPATH% oracle.jaccelerator.Deploy %args% 
@echo off
goto finish
